  ...
  return (
    <div>
        ...
        <a href="#" className="logo">
          ...
          <b>
            ...
            <span className="sspan">
              {" "}
              {isMobile ? "Murugan" : "Murugan Builders"}{" "}
            </span>{" "}
          </b>
        </a>

        <nav className="navbar">
          <Link to="home" smooth={true} duration={200} className="Anc">
            Home
          </Link>
          <Link to="about" smooth={true} duration={200} className="Anc">
            About
          </Link>
          <Link to="services" smooth={true} duration={200} className="Anc">
            Services
          </Link>
          <Link to="projects" smooth={true} duration={200} className="Anc">
            Projects
          </Link>
          <Link to="reviwes" smooth={true} duration={200} className="Anc">
            Reviews
          </Link>
          <Link to="contact" smooth={true} duration={200} className="Anc">
            Contact
          </Link>
      ...
      <div
        ...
        style={{ display: isContactInfoActive ? "block" : "none" }}
      >
        ...
        <div className="share">
          <a
            href="https://instagram.com/srimuruganbuilders?igshid=MzRlODBiNWFlZA=="
            className="fab fa-facebook-f a1"
          ></a>
          <a
            href="https://instagram.com/srimuruganbuilders?igshid=MzRlODBiNWFlZA=="
            className="fab fa-twitter a1"
          ></a>
          <a
            href="https://instagram.com/srimuruganbuilders?igshid=MzRlODBiNWFlZA=="
            className="fab fa-instagram a1"
          ></a>
          <a
            href="https://instagram.com/srimuruganbuilders?igshid=MzRlODBiNWFlZA=="
            className="fab fa-linkedin a1"
          ></a>
        </div>
      </div>
    </div>
